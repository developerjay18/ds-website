      ...
      <div className="px-5 lg:px-24 py-16 font-Poppins pt-[12rem]">
        ...
        <div className="rounded-lg px-10 text-[#2c2c2c] py-10 my-10 flex flex-col gap-6 bg-[#eeeeee]">
          <p>
            ...
            information.We collect personal data like your name, email, and
            phone number when you use our services. We use this information to
            provide our services, communicate with you, and offer relevant
            products. We also gather non-personal data for analytics.Your data
            is secure with us, protected by industry-standard measures like SSL
            encryption. However, data transmission security can&apos;t be
            guaranteed.We may share your information with affiliates for
            security purposes or when required by law. Third-party websites
            linked on our site have their own privacy policies.If you have any
            questions or need to remove a testimonial, contact us at{' '}
