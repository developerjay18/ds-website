...
function ProcessCard({ imgSrc, title, detail }) {
  return (
    <div className="shadow-lg hover:shadow-profBlue cursor-pointer py-5 px-3 rounded-xl w-[30%] flex flex-col justify-center items-center gap-5 bg-[#eeeeee] text-mateBlack">
      {/* images */}
