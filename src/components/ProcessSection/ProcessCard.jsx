...
function ProcessCard({ imgSrc, title, detail }) {
  return (
    <div className="shadow-lg hover:shadow-profBlue cursor-pointer py-5 px-3 rounded-xl w-[31%] flex flex-col justify-center items-center gap-5 bg-[#eeeeee] text-mateBlack">border
      {/* images */}
      <div className="image flex justify-center h-[40%]">
        <img
          src={imgSrc}
          alt="process-img"
          className="bg-white cloudy-wavy p-2 w-[60%] hover:shadow-lg hover:shadow-profBlue"
        />
      </div>
