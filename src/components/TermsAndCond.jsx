    ...
    <div className="px-5 lg:px-24 py-16 font-Poppins">
      ...
      <div className="rounded-lg px-10 text-[#2c2c2c] py-10 my-10 flex flex-col gap-6 bg-[#eeeeee]">
        ...
        <p>
          ...
          Conditions, “Decent settlement” is referred to as the “Company”, “us,”
          or “we.”
        </p>
        <p>
        ...
        <div className="flex flex-col gap-2">
          ...
          <p>
            The company isn&apos;t responsible for errors or damages.You&apos;re
            responsible for your hardware and internet fees.Use login
            credentials and follow the rules.We aim for uninterrupted service
            but can&apos;t guarantee it. Don&apos;t be rude or share harmful
            content.No hacking or spamming allowed.Don&apos;t copy or violate
            laws with content.We&apos;re not liable for damages or losses.You
            must indemnify us if you breach the terms. Some services have fees;
            you&apos;ll be notified.Refunds depend on the service
            agreement.Service fees are non-refundable after cancellation.
          </p>
        </div>
        <p>
          For any other information, you can write to us at
          <b className="text-profBlue"> decentsettlement@gmail.com</b> and keep
          in mind clearly in case any dispute arises, The place of jurisdiction
          will be at Ahmedabad city only.
        </p>
      </div>
    </div>
  );
